"""
Create a new Google Sheet and write Instantly lead data to it.
...
PEOPLE_HEADERS = [
    ...
    "location", "linkedin_url", "company_domain", "company_id",
]
...
def main():
    ...
    write_data(sheet_id, "Sheet1", PEOPLE_HEADERS, rows)
